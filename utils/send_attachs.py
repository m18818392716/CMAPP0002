...
# 构造附件3，传送当前目录下的 allure_report.zip 文件
att_zip = MIMEText(open(r'../allure_report.zip', 'rb').read(),'base64','utf-8')
att_zip["Content-Type"] = 'application/octet-stream'
att_zip["Content-Disposition"] = 'attachment; filename="Automation Test Report.zip"'
message.attach(att_zip)
try:
